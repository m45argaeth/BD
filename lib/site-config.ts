...
/** The educational SaaS in the same series. Shared across all sites. */
...
export const SITE: {
	...
	icon: Brain,
	tagline: {
		id: "Temukan jalan pintas tersembunyi yang dipakai otakmu.",
		en: "Discover the hidden shortcuts your brain uses.",
	},
}
